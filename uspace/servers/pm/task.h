...
result_t s_proc_get(pid_t pid, struct process_t** out_proc);
result_t s_proc_exit(pid_t pid, result_t exit_code);
result_t s_proc_watch(pid_t watcher, pid_t target);
result_t s_proc_unwatch(pid_t watcher, pid_t target);
...
result_t s_proc_kill(pid_t pid);
